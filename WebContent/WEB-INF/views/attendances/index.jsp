...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <table id="attendance_list">
            <tbody>
                <tr>
                    ...
                    <th class="attendance_date">出勤日付</th>
                    <th class="attendance_title">出勤時刻</th>
                    <th class="attendance_title">退勤時刻</th>
                    <th class="attendance_title">休憩時間</th>
                    <th class="attendance_title">実働時間</th>
        ...
        <p><a href="<c:url value='/attendances/new' />">新規出退勤の登録</a></p>
